...
const translations = {
  en: {
    ...
    spreadsheetPickerApiKeyError: 'The Google Picker API key is not configured for this frontend.',
  ...
  nl: {
    ...
    spreadsheetPickerApiKeyError: 'De Google Picker API-sleutel is niet geconfigureerd voor deze frontend.',
